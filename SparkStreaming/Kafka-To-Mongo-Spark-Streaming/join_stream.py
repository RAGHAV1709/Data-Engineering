...
query = stateful_query.writeStream \
    .outputMode("append") \
    .format("mongodb") \
    .option('spark.mongodb.connection.uri', "mongodb+srv://raghavSkills219@mongo-db-cluster.0iwho.mongodb.net/?retryWrites=true&w=majority&appName=mongo-db-cluster") \
