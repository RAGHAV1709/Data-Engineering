    ...
    sql="""
        ...
        USING (
            SELECT
                ...
                $3 AS email,
                $4 AS phone
            FROM @car_rental.PUBLIC.car_rental_data_stg/customers_{{ ti.xcom_pull(task_ids='get_execution_date') }}.csv (FILE_FORMAT => 'car_rental.PUBLIC.csv_format')
        ) AS source
...
PROJECT_ID = 'neon-obelisk-483721-k9'
REGION = 'us-central1'

pyspark_job_file_path = 'gs://snowflake-projects-raghav-gds/car_rental_spark_job/spark_job.py'
...
PYSPARK_JOB = {
    ...
    "pyspark_job": {
        ...
        "jar_file_uris": [
            "gs://snowflake-projects-raghav-gds/snowflake_jars/spark-snowflake_2.12-2.15.0-spark_3.4.jar",
            "gs://snowflake-projects-raghav-gds/snowflake_jars/snowflake-jdbc-3.16.0.jar"
        ]
    }
}
